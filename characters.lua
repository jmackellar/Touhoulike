game_characters = {	{name = 'Reimu Hakurei', stats = {name = 'Player', char = '@', team = 0, x = 25, y = 25, speed = 19, hp_max = 500, mana_max = 200, base_damage = {45, 55}},
					...
					{name = 'Marisa Kirisame', stats = {name = 'Player', char = '@', team = 0, x = 25, y = 25, speed = 16, hp_max = 300, mana_max = 500, base_damage = {50, 55}},
					player_stats = { str = 5, dex = 10, int = 8, con = 5 },
					starting_spells = {},
					player_spells_learn = {},
					},
					{name = 'Alice Margatroid', stats = {name = 'Player', char = '@', team = 0, x = 25, y = 25, speed = 20, hp_max = 350, mana_max = 450, base_damage = {45, 50}},
					player_stats = { str = 5, dex = 8, int = 9, con = 5 },
					starting_spells = {},
					player_spells_learn = {},
					},
					{name = 'Remilia Scarlet', stats = {name = 'Player', char = '@', team = 0, x = 25, y = 25, speed = 18, hp_max = 500, mana_max = 300, base_damage = {50, 60}},
					player_stats = { str = 10, dex = 7, int = 6, con = 6 },
					starting_spells = { },
					player_spells_learn = {},
					},
					{name = 'Sakuya Izayoi', stats = {name = 'Player', char = '@', team = 0, x = 25, y = 25, speed = 20, hp_max = 400, mana_max = 300, base_damage = {55, 65}},
					player_stats = { str = 6, dex = 7, int = 7, con = 6 },
					starting_spells = {	{name = 'Lunar Dial', mp_cost = 150, func = function () add_modifier({name = 'Lunar Dial', turn = 20, speed = 50}) end},
										},
					player_spells_learn = {},
					},
