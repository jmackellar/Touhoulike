game_items = {	--- items never randomly generated
				...
				{name = 'Yin-Yang Orb', slot = 'hand', weight = 5, crit = 15, damage = 25, char = ')', prob = 0},
				{name = 'Sweet Potato', edible = true, weight = 2, cook = false, nutrition = 175, char = '%', prob = 0},
				{name = 'Police Baton', slot = 'hand', weight = 3, damage = 30, char = ')', prob = 0},
				...
				{name = 'Purification Rod', slot = 'hand', weight = 4, damage = 15, char = ')', prob = 0, bullet = 1},
				...
				{name = 'Big Stick', slot = 'hand', damage = 10, char = ')', weight = 4, prob = 32},
				...
				{name = 'Katana', slot = 'hand', damage = 20, weight = 7, char = ')', apply = true, afunc = function () add_modifier({name = 'Samurai Spirit', turn = 200, power = 5}) end, message = "You feel the spirits of the samurai rush through your veins.", prob = 35},
				...
				{name = 'Broom', slot = 'hand', apply = true, weight = 2, afunc = function () end, message = "You sweep the ground.", damage = 10, char = ')', prob = 65},
				...
				{name = 'Dagger', slot = 'hand', damage = 18, weight = 4, char = ')', prob = 91},
