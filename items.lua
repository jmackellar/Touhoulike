game_items = {	--- items never randomly generated
				...
				{name = 'Potion of Mutation', quaff = true, potion = true, mut = 25, char = '!', pname = 'Unknown Potions', affect = function () give_random_mut() end, message = "You just drank a Potion of Mutation!", prob = 3200},
