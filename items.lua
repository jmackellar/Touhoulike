game_items = {	--- items never randomly generated
				...
				{name = 'Magic Mirror', apply = true, weight = 5, char = '(', message = "You gaze into the mirror.", afunc = function () level_connection['down'] = function (dir) map_hakurei_shrine('up') end next_level('down') end, prob = 0},
				{name = 'Yin-Yang Orb', slot = 'hand', weptype = 'shinto', weight = 5, crit = 15, damage = 25, char = ')', prob = 0},
				{name = 'Sweet Potato', edible = true, weight = 2, cook = false, nutrition = 175, char = '%', prob = 0},
				{name = 'Police Baton', slot = 'hand', weptype = 'stick', weight = 3, damage = 30, char = ')', prob = 0},
				...
				{name = 'Silk Dress', slot = 'legs', armor = 3, weight = 6, char = ']', prob = 30},
				...
				{name = 'Big Stick', slot = 'hand', weptype = 'stick', damage = 10, char = ')', weight = 4, prob = 32},
				...
				{name = 'Katana', slot = 'hand', weptype = 'longsword', damage = 20, weight = 7, char = ')', apply = true, afunc = function () add_modifier({name = 'Samurai Spirit', turn = 200, power = 5}) end, message = "You feel the spirits of the samurai rush through your veins.", prob = 35},
				...
				{name = 'Maid Outfit', slot = 'torso', armor = 3, weight = 6, char = ']', prob = 40},
				{name = 'Silk Bonnet', slot = 'head', armor = 1, weight = 1, char = '[', prob = 41},
				...
				{name = 'Potion of Weakness', quaff = true, potion = true, pname = 'Unkown Potion', char = '!', prob = 43, affect = function () local dice = math.random(1, 1) player_stats.str = player_stats.str - dice end, message = "You feel much weaker."},
				{name = 'Potion of Stupidity', quaff = true, potion = true, pname = 'Unkown Potion', char = '!', prob = 43, affect = function () local dice = math.random(1, 1) player_stats.int = player_stats.int - dice end, message = "You feel much stupider."},
				...
				{name = 'Scroll of Remove Armor', reads = true, scroll = true, pname = 'Unknown Scroll', char = '?', prob = 44, affect = function () player:armor_change(math.random(-1, -1)) end, message = "Your skin glows red for a moment."},
				{name = 'Scroll of Remove Damage', reads = true, scroll = true, pname = 'Unknown Scroll', char = '?', prob = 45, affect = function () player:base_dam_change(math.random(-10, -5)) end, message = "Your hands glow red for a moment."},
				{name = 'Robe', slot = 'torso', armor = 2, weight = 5, char = ']', prob = 55},
				{name = 'Sarashi', slot = 'torso', armor = 1, weight = 1, char = ']', prob = 56},
