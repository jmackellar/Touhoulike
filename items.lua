game_items = {	--- items never randomly generated
				...
				{name = 'Potion of Cure Mutation', quaff = true, potion = true, char = '!', prob = 5, pname = 'Unknown Golden Potion', affect = function () if # player_muts > 0 then local dice = math.random(1, # player_muts) table.remove(player_muts, dice) end end, message = "You feel more in touch with the human world."},
				...
				{name = 'Potion of Mutation', quaff = true, potion = true, mut = 25, char = '!', pname = 'Unknown Potions', affect = function () give_random_mut() end, message = "You just drank a Potion of Mutation!", prob = 32},
