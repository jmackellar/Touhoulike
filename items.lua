game_items = {	--- items never randomly generated
				...
				{name = 'Curved Sword', slot = 'hand', weptype = 'longblade', color = function () love.graphics.setColor(255, 255, 255, 255) end, damage = 12, weight = 6, char = ')', prob = 58},
				...
				{name = 'Dagger', slot = 'hand', weptype = 'shortblade', color = function () love.graphics.setColor(200, 200, 200, 255) end, damage = 10, weight = 4, char = ')', prob = 91},
