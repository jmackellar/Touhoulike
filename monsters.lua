game_monsters = {	--- unique monsters
					...
					{name = 'Shizuha Aki', armor = 10, speed = 1, unique = true, rand_gen = false, base_damage = {85, 95}, hp_max = 1, exp = 120, char = 'A', color = function () love.graphics.setColor(209, 61, 61, 255) end, level = 6},
					...
					{name = 'Wild Dog', armor = 0, base_damage = {15, 20}, rand_gen = true, evasion = 15, speed = 1, hp_max = 150, ai = 'melee', exp = 10, char = 'd', color = function () love.graphics.setColor(150, 150, 150, 255) end, level = 1},
					{name = 'Green Mold', armor = 0, base_damage = {45, 55}, rand_gen = true, speed = 1, evasion = 0, hp_max = 150, exp = 15, char = 'm', ai = 'sessile', color = function () love.graphics.setColor(0, 255, 0, 255) end, level = 2},
