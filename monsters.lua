game_monsters = {	--- unique monsters
					...
					{name = 'Little Oni', armor = 6, base_damage = {35, 45}, rand_gen = true, ai = 'melee', hp_max = 275, exp = 40, char = 'o', level = 2, color = function () love.graphics.setColor(255, 0, 0, 255) end,},
					{name = 'Tanuki', armor = 3, base_damage = {40, 50}, rand_gen = true, ai = 'melee', hp_max = 200, exp = 25, char = 'd', level = 2, color = function () love.graphics.setColor(255, 140, 140, 255) end,},
					...
					{name = 'Little Oni Shaman', armor = 4, base_damage = {55, 65}, rand_gen = true, ai = 'ranged', hp_max = 300, exp = 45, char = 'o', level = 3, color = function () love.graphics.setColor(255, 0, 100, 255) end,},
					{name = 'Toad', armor = 7, base_damage = {55, 65}, rand_gen = true, ai = 'melee', hp_max = 400, exp = 50, char = 't', level = 3, color = function () love.graphics.setColor(0, 255, 0, 255) end,},
				}
