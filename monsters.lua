game_monsters = {	--- unique monsters
					...
					{name = 'Turtle', armor = 10, base_damage = {25, 30}, rand_gen = true, evasion = 0, ai = 'melee', speed = 2, hp_max = 200, exp = 10, char = 'u', color = function () love.graphics.setColor(0, 255, 0, 255) end, level = 1},
					...
					{name = 'Wild Dog', armor = 0, base_damage = {15, 20}, rand_gen = true, evasion = 15, speed = 1, hp_max = 200, ai = 'melee', exp = 10, char = 'd', color = function () love.graphics.setColor(150, 150, 150, 255) end, level = 1},
					{name = 'Little Oni', armor = 6, base_damage = {25, 30}, speed = -1, rand_gen = true, ai = 'melee', corpse = 'oni', hp_max = 250, exp = 40, char = 'o', level = 2, color = function () love.graphics.setColor(255, 0, 0, 255) end,},
					...
					{name = 'Fairy', armor = 2, base_damage = {30, 37}, rand_gen = true, speed = 0, evasion = 8, corpse = 'fairy', hp_max = 275, exp = 30, char = 'f', level = 2, color = function () love.graphics.setColor(0, 255, 0, 255) end},
