game_monsters = {	--- unique monsters
					...
					{name = 'Little Oni', armor = 6, base_damage = {30, 35}, speed = -1, rand_gen = true, ai = 'melee', corpse = 'oni', hp_max = 250, exp = 40, char = 'o', level = 2, color = function () love.graphics.setColor(255, 0, 0, 255) end,},
