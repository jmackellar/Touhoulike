game_monsters = {	--- unique monsters
					...
					{name = 'Wild Dog', armor = 0, base_damage = {15, 20}, rand_gen = true, speed = 1, hp_max = 200, ai = 'melee', exp = 10, char = 'd', color = function () love.graphics.setColor(150, 150, 150, 255) end, level = 1},
