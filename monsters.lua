game_monsters = {	--- unique monsters
					...
					{name = 'Frog', armor = 4, base_damage = {15, 20}, rand_gen = true, ai = 'melee', speed = 15, hp_max = 100, exp = 15, char = 't', color = function () love.graphics.setColor(158, 255, 180, 255) end, level = 1},
					{name = 'Spirit', armor = 1, base_damage = {20, 25}, rand_gen = true, ai = 'melee', hp_max = 165, exp = 20, char = 's', level = 1},
					{name = 'Fire Fly', armor = 0, base_damage = {15, 20}, rand_gen = true, speed = 10, hp_max = 175, exp = 10, char = 'b', color = function () love.graphics.setColor(255, 255, 0, 255) end, level = 1},
